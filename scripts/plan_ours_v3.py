...
args.savepath = args.savepath + "_replan_v3"
...
if args.replan:
    ...
    for i in range(n_evals):
        ...
        with tqdm(total=max_steps, desc="Env Steps") as pbar:
            while total_steps < max_steps and not done:
                # Execute all planned actions before replanning
                ...
                # Replan from current observation after executing the full plan
